...
{
    port_config_t *cfg =
        calloc(1, sizeof(port_config_t));        // Must be freed later via port_free_info()
    port_info_t *pi;
...
int
port_stats(uint16_t pid, void *stats_ptr)
{
