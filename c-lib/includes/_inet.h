...
#define INET_IPADDR_V4      0x01
#define INET_IPADDR_V6      0x02
#define INET_IPADDR_NETWORK 0x04

#define INET_INADDRSZ    4
#define INET_IN6ADDRSZ   16
#define INET_PREFIXMAX   128
#define INET_V4PREFIXMAX 32
...
#define INET_ISFRAG(off) ((off) & (INET_OFF_MF | INET_OFF_MASK))
#define INET_OFF_MASK    0x1fff
#define INET_OFF_MF      0x2000
#define INET_OFF_DF      0x4000
 ...
 */
#define INET_IPPROTO_NONE       0
#define INET_IPPROTO_IP         IPPROTO_IP
#define INET_IPPROTO_ICMP       IPPROTO_ICMP
#define INET_IPPROTO_IGMP       IPPROTO_IGMP
#define INET_IPPROTO_IPV4       IPPROTO_IPV4
#define INET_IPPROTO_TCP        IPPROTO_TCP
#define INET_IPPROTO_UDP        IPPROTO_UDP
#define INET_IPPROTO_IPV6       IPPROTO_IPV6
#define INET_IPPROTO_IPV6_ROUTE 43
#define INET_IPPROTO_IPV6_FRAG  44
#define INET_IPPROTO_GRE        IPPROTO_GRE
#define INET_IPPROTO_ICMPV6     IPPROTO_ICMPV6
#define INET_IPPROTO_IPV6_ICMP  IPPROTO_ICMPV6
#define INET_IPPROTO_IPV6_NONXT 59
#define INET_IPPROTO_IPV6_OPTS  60
#define INET_IPPROTO_RAW        IPPROTO_RAW
#define INET_IPPROTO_USR_DEF    255
#define INET_IPPROTO_MAX        256

#define INET_IPPROTO_L4_GTPU_PORT 2152
...
union icmp_data {
    ...
    struct {
        ...
        uint32_t advert[1];    /* advertised values */
    } advertise;
 ...
 * Reserved1: must be 0
 * Key: 32bit number determined by the encapsulated packet
...
inet_ntop6(char *buff, int len, uint8_t *ip6, unsigned prefixlen)
{
    ...
    if (prefixlen > INET_PREFIXMAX) {
        prefixlen ^= (nprint = prefixlen >> 8) << 8;
        ntrim = prefixlen != INET_PREFIXMAX ? (prefixlen >= 100  ? 3
                                               : prefixlen >= 10 ? 2
                                                                 : 1) +
                                                  1
                                            : 0;
