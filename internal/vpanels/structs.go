...
// - pageInfo (VPanelConfig): A struct containing configuration information for the panel.
//
...
type VPanelFunc func(pageInfo VPanelConfig) (*VPanelInfo, error)
...
type VPanelConfig struct {
	...
	Panel *kview.Panels      // Primary panel
