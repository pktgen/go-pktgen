...
func (db *BindIO) Update() error {

	return db.parsePciInfo()
}

func (db *BindIO) IOBindPorts(devices []string) error {
...
func (db *BindIO) IOUnbindPorts(devices []string) error {
...
func (db *BindIO) BindPorts(devices []string) error {
...
func (db *BindIO) UnbindPorts(devices []string) error {
...
func (db *BindIO) PciNetList() []NetPCI {
