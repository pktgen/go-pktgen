...
const textView1 = `[green]func[white] [yellow]main[white]() {
    ...
    textView := kview.[yellow]NewTextView[white]().
...
func TextView1(nextSlide func()) (title string, info string, content kview.Primitive) {
	textView := kview.NewTextView()
	textView.SetVerticalAlign(kview.AlignBottom)
...
[green]func[white] [yellow]main[white]() {
    ["0"]textView[""] := kview.[yellow]NewTextView[white]()
...
func TextView2(nextSlide func()) (title string, info string, content kview.Primitive) {
	...
	textView.SetScrollBarVisibility(kview.ScrollBarAuto)
