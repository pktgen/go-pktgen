/*
A presentation of the kview package, implemented with cview.
...
type Slide func(nextSlide func()) (title string, info string, content kview.Primitive)

// The application.
var app = kview.NewApplication()
...
func main() {
	...
	for index, slide := range slides {
		...
		if info != "" {
			...
			h.SetText("  [" + kview.ColorHex(kview.Styles.SecondaryTextColor) + "]Info:[-]  " + info)
		}

		// Create a Flex layout that centers the logo and subtitle.
		f := kview.NewFlex()
		f.SetDirection(kview.FlexRow)
